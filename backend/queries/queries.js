...
const getReviews = " SELECT s.name AS errand, CONCAT(u.name,' ',u.surname) AS client_name,reason, rating  from users u, service s, review r, request rq where u.id=r.client_id and s.id=rq.service_id and r.request_id=rq.id and r.runner_id=$1";
